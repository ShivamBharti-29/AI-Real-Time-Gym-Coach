    ...
    if not workout_started:
        ...
        if st.button("Run camera diagnostic"):
            ...
            <div style="font-family: sans-serif; padding: 12px;">
              ...
              <div id="out" style="white-space: pre-wrap; background:#111; color:#0f0; padding:8px; height:120px; overflow:auto; border-radius:6px;"></div>
            ...
            '''
            components.html(camera_test_html, height=400, scrolling=True)
